# 🔄 100-Cycle 트래커 (퍼포먼스 마케팅 일상 루틴 자동화)

목표: 퍼마 분석가의 **일상 루틴**을 한 사이클에 하나씩, 코드검증 + 커밋·푸시로 완성. 100 사이클까지.
...
## ⬜ 큐 (퍼마 일상 루틴 — 다음 사이클들)
21 일일 알림 다이제스트(페이싱+이상치+가드레일 통합) · 22 검색어/네거티브 키워드 발굴 ·
23 소재 로테이션/피로 리프레시 스케줄 ·
